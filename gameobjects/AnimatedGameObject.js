"use strict"
    ...
    function AnimatedGameObject(layer, id) {
        SpriteGameObject.call(this, null, layer, id)
    ...
    AnimatedGameObject.prototype = Object.create(SpriteGameObject.prototype)
    ...
    var AnimatedGameObject = new AnimatedGameObject()
